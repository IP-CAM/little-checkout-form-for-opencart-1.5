...
<div class="buttons">
  <div class="right">
    <input type="button" class="button" id="button-confirm" value="Подтвердить заказ">
  </div>
</div>
...
<script type="text/javascript">
	$('#button-confirm').bind('click', function() {
		$.ajax({ 
			...
			success: function() {
				$('.checkout').html('Спасибо за заказ! В ближайшее время с Вами свяжется менеджер! Ваш номер заказа #<?php echo $order_id; ?>. ');;
			}		
		});
	});
</script>
