...
<div id="content"><h1 class="heading-title"><?php echo $heading_title; ?></h1><?php echo $content_top; ?>
  <div class="checkout">
    <div id="checkout">
      <div class="checkout-heading">Способ оформления заказа<?php //echo $text_checkout_option; ?></div>
    ...
    <div id="confirm">
      <div class="checkout-heading">Подтверждение заказа<?php //echo $text_checkout_confirm; ?></div>
      <div class="checkout-content"></div>
    </div>
  </div>
...
$('#button-register, #button-guest-shipping, #button-guest, #button-payment-method').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/payment_method/validate', 
		type: 'post',
		data: $('#payment-method input[type=\'radio\']:checked, '+
				'#payment-method input[type=\'checkbox\']:checked, '+
				'#payment-address .checkout-content input[name="firstname"], '+
				'#payment-address .checkout-content input[name="lastname"], '+
				'#payment-address .checkout-content input[name="email"], '+
				'#payment-address .checkout-content input[name="telephone"], '+
				'#payment-address .checkout-content input[name="address_1"], '+
				'#payment-address .checkout-content input[name="city"], '+
				'#payment-address .checkout-content input[name="password"], '+
				'#payment-address .checkout-content input[name="confirm"], '+
				'#payment-address .checkout-content textarea[name="comment"], '+
