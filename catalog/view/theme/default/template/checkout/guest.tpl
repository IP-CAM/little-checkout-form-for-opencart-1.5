...
<div class="right">
  <h2 class="secondary-title">Адресные данные<?php //echo $text_your_address; ?></h2>
  <!--
...
<br />
  ...
  -->
<?php if (true) { //($shipping_required) { ?>
<div style="display: none; clear: both; padding-top: 15px; border-top: 1px solid #DDDDDD;">
  <?php if (true) { // ($shipping_address) { ?>
